...
@CucumberOptions(
        ...
        glue = "steps",//Çalıştırılacak Java classlarının yolu buraya belirtilmelidir
        tags = "@candidat",//Özel olarak çalıştırılacak Scenario yada Feature Tag'i buraya belirtilir
